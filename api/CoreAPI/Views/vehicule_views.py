...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        tags=['Vehicule-endpoints']
    ),
)
class CreateVehicule(CreateAPIView):
...
class UpdateVehicule(UpdateAPIView):
    # permission_classes = [IsAuthenticated, IsAdminUser]
    queryset = VehiculeModel.objects.all()
    serializer_class = VehiculeSerializer
...
class RetrieveVehicule(RetrieveAPIView):
    # permission_classes = [IsAuthenticated, IsAdminUser]
    queryset = VehiculeModel.objects.all()
    serializer_class = VehiculeSerializer
...
class DestroyVehicule(DestroyAPIView):
    # permission_classes = [IsAuthenticated, IsAdminUser]
    queryset = VehiculeModel.objects.all()
    serializer_class = VehiculeSerializer
...
class ListVehicule(ListAPIView):
    # permission_classes = [IsAuthenticated, IsAdminUser]
    queryset = VehiculeModel.objects.all()
    serializer_class = VehiculeSerializer
